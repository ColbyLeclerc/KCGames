<html>
	...
	<body>
		...
		<?PHP
			...
			$query = "SELECT gm.Title, rv.Description, rv.Star_Rating, rv.Author FROM Game as gm, Review as rv WHERE gm.GameID = rv.GameID AND gm.GameID = $game GROUP BY rv.Star_Rating, gm.Title, rv.Description, rv.Author ORDER BY rv.Star_Rating DESC LIMIT 1 ";
